const Services = () => {
  return (
    <>
      <div id="service" className=" max-w-full mx-0  mt-34 pt-12 md:pt-52 bg-slate-50 ">
        <h1 className=" mx-1 md:mx-12  p-0 md:p-3 text-5xl font-bold text-indigo-600">
          Guest Rooms
        </h1>
          ...
          <div className=" left mx-0 md:mx-1 w-full md:w-1/2 h-auto items-center  ">
            <div className="w-11/12 h-72  mx-auto my-12 p-0 flex flex-col-reverse bg-[url('/img/room_1.jpg')] bg-center bg-cover content-none ">
              <div className=" mx-0 px-4 w-full bg-opacity-20 bg-slate-900 ">
                <p className=" m-0 my-3 text-xl hover:text-4xl transition-all text-white  ">
