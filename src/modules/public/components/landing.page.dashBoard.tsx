  ...
  return (
    <div className="w-full  h-screen mx-0 mt-0 bg-[url('/img/hotel_outdoor.jpg')] bg-center bg-cover ">
      <div className="w-full h-full m-0 p-0  ">
        <div className="px-6 md:px-12  md:mt-auto pt-20 md:pt-24 w-full h-full bg-transparent bg-gradient-to-t md:bg-gradient-to-r from-white ">
          ...
          <p className="p-1 my-12 mt-12 text-xl md:text-2xl text-black font-nunito w-full md:w-1/2 font-bold ">
          ...
          <a
            className="mx-3 my-12 py-4 px-16 bg-indigo-600 text-xl font-roboto text-white hover:bg-gradient-to-r from-purple-800 cursor-pointer rounded-md transition-all "
